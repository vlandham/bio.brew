...
There are a few ways to install and configure Bio Brew. My preferred method involves
checking out the source from github using git. The requirement for this method is 
of course that you need git installed on your system.
